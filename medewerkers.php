    ...
    <div class="bg-white p-4 rounded-lg shadow mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <?php
                $result = $conn->query("SELECT id, voornaam, achternaam, email, telefoon, rol, status FROM gebruikers");
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <form method='POST' action='delete-medewerker.php'  onsubmit='return confirm(\"Weet je zeker dat je deze medewerker wilt verwijderen?\");'>
