            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center">
                    <div class="relative mr-4">
                        <input type="text" id="search-klanten" placeholder="Zoeken..." class="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500">
